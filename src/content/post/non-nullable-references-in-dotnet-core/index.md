...
tags : ["dotnetcore", "csharp", "visual studio", "Resharper", "non-nullable"]
highlight: true
...
__UPDATE 2020-02-23:__ I've prepared a code snippet for `.editorconfig` that sets severity level to error for different rules related to the reference nullability. Snippet available as [gist](https://gist.github.com/cezarypiatek/f56c671c6f634aab285a88095488c1de). You can read more about configuring Roslyn analyzers rules via `.editorconfig` at MSDN [Set rule severity in an EditorConfig file](https://docs.microsoft.com/en-US/visualstudio/code-quality/use-roslyn-analyzers?view=vs-2019#set-rule-severity-in-an-editorconfig-file) 
